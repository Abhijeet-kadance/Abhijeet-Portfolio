  ...
  const experiences = [
    {
      ...
      company_name: "CDAC Pune",
      icon: cdac,
      iconBg: "#383E56",
      date: "October 2022 - 2024(Current)",
      points: [
        "Developing and maintaining web applications using various backend stacks.",
        "Deploying Applications to application servers and configuring web-servers.",
        "Configuring SSL Certificates, web server security and fixing security audit bugs.",
        "Dockerizing diffrent Applications and setting Up CI/CD piplines",
